...
const DEFAULT_SYSTEM_PROMPT = "Clarify the user’s request and goal, then rewrite it clearly according to the greatest principle. Preserve the original language and intent. Do not add information or change the request. Focus only on improving clarity.";
